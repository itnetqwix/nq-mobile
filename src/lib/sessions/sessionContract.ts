...
/** Asymmetric end-call — partner chooses whether to end the booking. */
export const SESSION_DEPARTURE_SOCKET_EVENTS = {
  PROMPT: "SESSION_DEPARTURE_PROMPT",
  RESOLVED: "SESSION_DEPARTURE_RESOLVED",
  STAYED: "SESSION_DEPARTURE_STAYED",
} as const;
